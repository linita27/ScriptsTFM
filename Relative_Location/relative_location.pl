...
#open(my $location, '>', "home/lina/SAC/Z_SCRIPTS/Relative_Location/location.txt");
open(my $location, '>', 'location.in');
...
@take_off_angle_P[$i]=$format_az->write(@angle[$i]);
chomp @take_off_angle_P[$i];
}
...
#P waves
      ...
      $num=1;
            for($k=0;$k<$j;$k++){
              print $location "@stat[$k] $num@take_off_angle_P[$k]@az[$k]\n"; #location.in
              print "@stat[$k] $num@take_off_angle_P[$k]@az[$k]\n";
        ...
        #Computing input for location.in
            ...
            @take_off_angle_S[$i]=$format_az->write(@angle[$i]);
            chomp @take_off_angle_S[$i];
            #print "@take_off_angle_S[$i]\n";
            }
...
#S waves
                        ...
                        for($k=0;$k<$j;$k++){
                          print $location "@stat[$k] $num@take_off_angle_S[$k]@az[$k]\n"; #location.in
                          print "@stat[$k] $num@take_off_angle_S[$k]@az[$k]\n";
                        ...
                        @take_off_angle_pP[$i]=$format_az->write(@angle[$i]);
                        chomp @take_off_angle_pP[$i];
                        }

                        #print "@take_off_angle_pP";
...
#pP waves
                                    ...
                                    for($k=0;$k<$j;$k++){
                                      print $location "@stat[$k] $num@take_off_angle_pP[$k]@az[$k]\n"; #location.in
                                      print "@stat[$k] $num@take_off_angle_pP[$k]@az[$k]\n";
                                      print $reloc "2 1 $num 2 1 P @time_difference[$k]\n"; #dtime.dat
                                      $num++;
                                    }
