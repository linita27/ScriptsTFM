...
#***************************************************************************
#Only valid results using data with gcarc between 70 and 90. The tables have fake data outside that interval
#***************************************************************************
...
open(my $focmec, '>', '00_input_FocMec_pP.txt');
...
#Creating input for FOCMEC
     ...
     $j=0;
      ...
      $j=0;
            ...
            for($k=0;$k<$j;$k++){
              print $focmec "@stat[$k]@az[$k]@take_off_angle[$k]\n";
            }
